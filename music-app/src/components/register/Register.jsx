    ...
    return (
        <div className="bg-[url(/src/assets/background-register.jpg)] bg-center bg-cover h-screen flex justify-center items-center font-rubik">
            ...
            <div className="border-zinc-300 px-10 pt-28 pb-16 z-0 w-1/3 border-2 rounded-3xl backdrop-blur shadow-lg shadow-black">
                    <div className=" w-7 h-7 absolute -translate-y-0.5 top-0 left-24 ml-2 translate-x-1.5 rounded-se-3xl shadow-se"></div>
                    ...
                    <div className="w-7 h-7 absolute -translate-y-0.5 top-0 left-72 ml-2 rounded-ss-3xl shadow-ss"></div>
                    ...
                    <div className="relative flex flex-col mb-5">
                        <input placeholder="" type="password" className="w-full h-14 text-base bg-transparent text-zinc-300 py-5 px-5 border-zinc-300 border-2 rounded-full outline-none mb-2.5 shadow-zinc-300 peer" />
                        <label htmlFor="" className="absolute select-none peer-placeholder-shown:bg-transparent peer-placeholder-shown:px-0 peer-placeholder-shown:font-normal peer-placeholder-shown:text-base peer-placeholder-shown:text-zinc-300 peer-placeholder-shown:top-4 left-5 duration-200 peer-focus:-top-2.5 peer-focus:text-sm peer-focus:bg-zinc-300 peer-focus:rounded-full peer-focus:px-3 peer-focus:text-teal-950 peer-focus:font-bold  -top-2.5 text-sm bg-zinc-300 rounded-full px-3 text-teal-950 font-bold font-rubik pointer-events-none">Repeat Password</label>
                        <span className="material-symbols-outlined absolute text-zinc-300 top-2 right-5 text-3xl select-none">lock</span>
                    </div>
                    <div className="relative flex flex-col mb-5">
                        <input type="submit" className="h-12 rounded-full bg-zinc-300 font-rubik font-black text-teal-950 duration-300 active:bg-zinc-400" value="Create Account " />
                    </div>
                    <div>
